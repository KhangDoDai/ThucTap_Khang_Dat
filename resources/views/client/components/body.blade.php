    ...
    <div class="container">
        <div class="d-md-flex justify-content-center gap-3 mt-3 mb-5">
            <div class=">
                ...
                srcset="{{ asset('imgs/doanvien.jpg') }}">
            </div>
            <div class=">
                <img class=" img-fluid" src={{ asset('imgs/combohoa.jpg') }} alt=""
                srcset="{{ asset('imgs/combohoa.jpg') }}">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="d-flex flex-column justify-content-between">
            ...
            <div class="row g-3">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    Khóa học PROS cập nhật theo tiến độ, bám sát chương trình học trên trường và chương trình luyện thi
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    Có group hỗ trợ giải đáp
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    Khóa học có cập nhật đề thi giữa kì, cuối kì, kiến thức ĐGNL và các xu hướng ra đề mới nhất của BGD
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    Đối tượng: Học sinh các trình độ muốn học theo một lộ trình bài bản, có thời gian, kế hoạch học tập
                    cụ thể
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="shadow-sm card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-center"><span class="text-danger">{{currency_format(799000)}}</span>
        ...
        <ul class="nav nav-underline border" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link py-md-2 px-md-5 px-2 active" id="combo6-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="true">COMBO 6</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link py-md-2 px-md-5 px-2" id="combo7-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false">COMBO 7</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link py-md-2 px-md-5 px-2" id="combo8-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false">COMBO 8</button>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="combo7-tab-pane" role="tabpanel" aria-labelledby="combo7-tab" tabindex="0">
                <div class="border-bottom">
                    <p class="p-3 m-0"></p>
                </div>
                <div class="row my-4 gap-3 mx-2">
            ...
            <div class="tab-pane fade" id="combo8-tab-pane" role="tabpanel" aria-labelledby="combo8-tab" tabindex="0">
                <div class="border-bottom">
                    <p class="p-3 m-0"></p>
                </div>
                <div class="row my-4 gap-3 mx-2">
